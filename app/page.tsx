              ...
              {isSizeButtonsSelected ? (
                <div className="w-full relative flex flex-nowrap gap-4 justify-center items-center overflow-x-auto">
                  ...
                  {sizeOptions.map((sizeOption) => (
                    <div
                      key={sizeOption}
                      className={`w-full max-w-xs md:max-w-md h-52 md:h-[448px] relative ${selectedSize === sizeOption ? 'border-blue-400 border-2' : ''
                        }`}
                      ref={(el) => {
                ...
                <div
                  className={`w-full h-52 max-w-xs md:h-[448px] md:max-w-md ${animateImage ? 'animate-up' : ''
                    }`}
                >
                  <div className="relative">
            ...
            <div className="w-full max-w-screen-2xl">
              <div className="flex flex-nowrap justify-center overflow-x-auto">
                ...
                {isBandButtonsSelected ? (
                  <>
                    <div className="rounded-3xl flex flex-nowrap flex-row text-[17px] bg-[#E8E8ED] px-5 py-2">
